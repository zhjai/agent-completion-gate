...
<p align="center">
  ...
  <img alt="version" src="https://img.shields.io/badge/version-0.4.1-informational">
...
`v0.4.1` preview. MIT. Agent-agnostic, file-based, fail-closed. Optional companion: [`agent-lessonbook`](https://github.com/zhjai/agent-lessonbook).
